...
3.addNode() will add a new node to the list:
    ...
    d.If the list is not empty, the new node will be added to end of the list such that tail's next will point to the newly added node. This new node will become the new tail 
    of the list.    a.Define a node current which initially points to the head of the list.
